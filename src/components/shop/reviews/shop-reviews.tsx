...
const SHOP_REVIEWS = ALL_REVIEWS.filter(
...
const ShopReviews = () => {
  ...
  const totalPages = Math.ceil(SHOP_REVIEWS.length / REVIEWS_PER_PAGE);
  const visibleReviews = SHOP_REVIEWS.slice(0, currentPage * REVIEWS_PER_PAGE);
